...
#define	MASK_POTION		(1 << 2)	// 2^2		00000001	0x04	04
#define	MASK_GUNTLET	(1 << 3)	// 2^3		00000001	0x08	010
#define	MASK_HAMMER		(1 << 4)	// 2^4		00000001	0x10	020
#define	MASK_KEY		(1 << 5)	// 2^5		00000001	0x20	040
#define	MASK_RING		(1 << 6)	// 2^6		00000001	0x40	0100
#define	MASK_AMULET		(1 << 7)	// 2^7		00000001	0x80	0200
